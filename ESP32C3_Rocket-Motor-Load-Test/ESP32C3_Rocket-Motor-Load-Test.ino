...
void loop()
{
    ...
    // A captura começa em ARMED. Suspendemos HTTP/Wi-Fi durante todo
    // o ciclo ativo para não perder conversões do HX711.
    if (!acquisitionIsBusy())
    {
        wifiManager.loop();
        webServer.loop();
    }
